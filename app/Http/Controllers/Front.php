...
class Front extends Controller
{
   ...
   // Admin section end here
    ...
    public function index(){
        // dd('hello');
        $data['featured_listing'] = $this->common_model->getlistingdetails([['listing.status','=',1],['listing.is_featured','=',1],['listing.type','!=',1],['listing.type','!=',2]],3);
        $data['featured_bricks'] = $this->common_model->getlistingdetails([['listing.status','=',1],['listing.is_featured','=',1],['listing.type','=',2]]);
        $data['featured_listing_count'] = $this->common_model->getlistingdetails_count([['listing.status','=',1],['listing.is_featured','=',1],['listing.type','!=',1],['listing.type','!=',2]]);
        return view('landing',$data);
       
    }
    public function featured_listing(){
        $data['listing'] = $this->common_model->getlistingdetails([['listing.status','=',1],['listing.is_featured','=',1],['listing.type','!=',1],['listing.type','!=',2]],items_count());
        $data['total_count'] = $this->common_model->getlistingdetails_count([['listing.status','=',1],['listing.is_featured','=',1],['listing.type','!=',1],['listing.type','!=',2]]);
        $data['is_featured'] = 1;
    ...
    public function bricks_listing(){
    	...
    	return view('bricks-listing',$data);
    }
    ...
    public function full_space_listing(){
        ...
        return view('full-spacelisting',$data);
    }
    ...
    public function partial_space_listing(){
    	...
    	return view('partial-spacelisting',$data);
    }
    ...
    public function popup_store_listing(){
    	...
    	return view('popup-storelisting',$data);
    }
    ...
    public function event_fair_listing(){
    	...
    	return view('event-fairlisting',$data);
    }
    ...
    public function resource_details($id=''){
        ...
        $data['tags'] = $this->common_model->selectdata('resources_tags',[['status','=', 1]],array('name' => 'asc'));
        $data['id'] = $id;
        $data['listing_images'] = $this->common_model->selectdata('listing_resouce_files',['resource_id'=>$id]);
        $data['comments'] = $this->common_model->getresource_comments($id);
    	return view('resource-details',$data);
    }
    ...
    public function resetpassword($token){
        ...
        return view('resetpassword')->with('user_id',$user_id);
    }
     ...
     public function do_signup(Request $request){
        if(!empty($request->email)){
            $common_model = new Common();
             ...
             $file1 = $request->file('company_icon');
            $image_name = '';
            $image_name1 = '';
            ...
            if(!empty($file1)){
                ...
                $file_name = str_replace(' ','_',time().$file1->getClientOriginalName());
                if($file1->move($destinationPath,$file_name)){
                    $image_name1 = $file_name;                  
                }
            }
