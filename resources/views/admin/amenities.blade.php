...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Amenities Categories</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Amenities Categories
                    <a style="float: right;" href="{{url('/')}}/admin/add-amenities"><button type="button" class="btn btn-dark">Add New</button></a>
                </h5>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($cat->status != 2)
                                            ...
                                            @endif
                                            <a href="{{url('/')}}/admin/edit-amenities/{{$cat->id}}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">        
                <button type="button" class="btn btn-primary" id="confirm_amenties_cat_deact">Yes</button>
