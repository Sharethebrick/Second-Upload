...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">{{empty($cat_id) ? 'Add' : 'Edit'}} Tag</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/')}}/admin/dashboard" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{url('/')}}/admin/resources-tags" class="breadcrumb-link">Tags</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{empty($cat_id) ? 'Add' : 'Edit'}} Tag</li>
                            </ol>
                        </nav>
                    </div>
                </div>
       ...
       <input type="hidden" id="token" value="{{ Session::token() }}"> 
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">{{empty($cat_id) ? 'Add' : 'Edit'}} Tag</h5>
                <div class="card-body">
                    <form id="add_tag_form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name" placeholder="Tag Name" class="form-control" value="{{!empty($tag) ? $tag->name : ''}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row text-right">
                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                ...
                                <a href="{{url('/')}}/admin/resources-tags">
...
$(function() {
     ...
     name:
      {
          required: true,
           remote: {
                  url: BASE_URL+'/admin/check_tag_name',
                  type: "post",
  ...
  messages: {
    name: 
          {
            remote: "Tag name already exists."
          },
  },
        ...
        $.ajax({
            ...
            success: function(result) {
              $(".add_user_btn").html('Submit').removeAttr('disabled','disabled');
                if(result.status == 1){  
                  window.location.href = BASE_URL+'/admin/resources-tags';             
                }
                else{
