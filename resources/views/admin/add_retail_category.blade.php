                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/')}}/admin/retail-categories" class="breadcrumb-link">Retail Categories</a></li>
                    ...
                    <form id="add_partial_space_cat_form">
                        ...
                        <div class="form-group row text-right">
                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                ...
                                <a href="{{url('/')}}/admin/retail-categories">
     ...
     name:
      {
          required: true,
           remote: {
                  url: BASE_URL+'/admin/check_retail_cat_name',
                  type: "post",
  ...
  submitHandler: function(form) {
    $(".signup-errors").hide().html('');
      $(".add_user_btn").html('<i class="fa fa-spinner fa-spin"></i>').attr('disabled','disabled');
        $.ajax({
            url: BASE_URL+'/admin/add_retail_cat',
            type: 'POST',
            dataType: 'json',
            ...
            success: function(result) {
              $(".add_user_btn").html('Submit').removeAttr('disabled','disabled');
                if(result.status == 1){  
                  window.location.href = BASE_URL+'/admin/retail-categories';             
                }
                else{
