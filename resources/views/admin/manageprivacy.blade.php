                        ...
                        @csrf
                         <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="privacy_page_title" placeholder="Enter page title" class="form-control" value="{{$page[1]->value}}">
                            </div>
                        </div>
                        <div class="form-group row err_place">
                            <textarea class="form-control" id="summernote" name="privacy" rows="6" >{{$page[0]->value}}</textarea>
                        </div>
