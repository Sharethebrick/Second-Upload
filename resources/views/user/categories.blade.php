                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg1" style="background-image: url({{url('/')}}/img/1.jpg);">
                                        ...
                                        <h3>Bricks</h3>
                                        <a href="{{url('/user-bricks')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-bricks')}}" class="link-btn"></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg2" style="background-image: url({{url('/')}}/img/2.jpg);">
                                        ...
                                        <h3>Brands</h3>
                                        <a href="{{url('/user-brands')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-brands')}}" class="link-btn"></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg3" style="background-image: url({{url('/')}}/img/3.jpg);">
                                        ...
                                        <a href="{{url('/user-full-space')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-full-space')}}" class="link-btn"></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg4" style="background-image: url({{url('/')}}/img/4.jpg);">
                                        ...
                                        <h3>Partial Space </h3>
                                        <a href="{{url('/user-partial-spaces')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-partial-spaces')}}" class="link-btn"></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg5" style="background-image: url({{url('/')}}/img/5.jpg);">
                                        ...
                                        <a href="{{url('/user-popup-landloard')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-popup-landloard')}}" class="link-btn"></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-categories-listing-item bg6" style="background-image: url({{url('/')}}/img/6.png);">
                                        ...
                                        <a href="{{url('/user-events-fairs')}}" class="learn-more-btn">View Listings <i class='bx bx-chevron-right'></i></a>
                                        <a href="{{url('/user-events-fairs')}}" class="link-btn"></a>
                                    </div>
                                </div>
