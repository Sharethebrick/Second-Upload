            ...
            <div class="container">
                ...
                <div class="col-md-12">
                     <div class="listings-alls">
                        <div class="billing-details">
                            <h3 class="title font-strs font-sma">User Bricks    <a href="{{url('/add-brick')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                        </div>
                        <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="listing-image">
                                                <a href="{{url('/brickdetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>

                                                <div class="listing-tag">
                                                    <a href="{{url('/brickdetails')}}/{{$key->id}}" class="d-block">{{$key->no_of_openings}} Openings</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="listing-content pl-0">
                                                <h3><a href="{{url('/brickdetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                            ...
                                            <div class="listing-box-footer br-st-a">
                                                <a href="{{url('/brickdetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                <a href="{{url('/edit-brick')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                ...
                @elseif($title == 'User Brands')
                    <div class="col-md-12">
                     <div class="listings-alls">
                        <div class="billing-details">
                            <h3 class="title font-strs font-sma">User Brands    <a href="{{url('/add-brand')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                        </div>
                        <div class="row">  
                    <div class="col-md-12">
                        <div class="main-search-wrap fll-s-st">  
                              ...
                              <div class="col-lg-12 col-sm-12 col-md-6 single_listing_item{{$key->id}}">
                                    <div class="single-listing-item new-stl-lyt">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="listing-image">
                                                    <a href="{{url('/branddetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>
                                                    @if($key->open_to_collaborations == 1)
                                                    <div class="listing-tag">
                                                        <a href="{{url('/branddetails')}}/{{$key->id}}" class="d-block">
                                            ...
                                            <div class="col-md-8">
                                                <div class="listing-content pl-0">
                                                    <h3><a href="{{url('/branddetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                                    <p class="mt-2 mb-2 fontsizepara">{{Getdesc($key->description,200,1)}}</p>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="price">
                                                            <b data-toggle="tooltip" data-placement="top">
                                                ...
                                                <div class="listing-box-footer br-st-a">
                                                    <a href="{{url('/branddetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                    <a href="{{url('/edit-brand')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                                                    <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#delete-pop" class="delete_listing delete-ayr"> <i class="bx bx-trash"></i> </a>
                ...
                @elseif($title == 'User Full Space Listings')
                    <div class="col-md-12">
                     <div class="listings-alls">
                        <div class="billing-details">
                            <h3 class="title font-strs font-sma">Full Space Listings    <a href="{{url('/add-full-space-landlord')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                        </div>
                         <div class="row">
                    <div class="col-md-12">
                        <div class="main-search-wrap fll-s-st">
                              ...
                              <div class="col-lg-12 col-sm-12 col-md-6 single_listing_item{{$key->id}}">
                                    <div class="single-listing-item new-stl-lyt">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="listing-image">
                                                    <a href="{{url('/fullspacedetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>

                                                    <div class="listing-tag">
                                                        <a href="{{url('/fullspacedetails')}}/{{$key->id}}" class="d-block">{{$key->space_category}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="listing-content pl-0">
                                                    <h3><a href="{{url('/fullspacedetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                                    <p class="mt-2 mb-2 fontsizepara">{{Getdesc($key->description,200,1)}}</p>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="price">
                                                            <b data-toggle="tooltip" data-placement="top">
                                                ...
                                                <div class="listing-box-footer br-st-a">
                                                    <a href="{{url('/fullspacedetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                    <a href="{{url('/edit-full-space-landlord')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                                                    <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#delete-pop" class="delete_listing delete-ayr"> <i class="bx bx-trash"></i> </a>
                ...
                @elseif($title == 'User Partial Space Listings') 
                    <div class="col-md-12">
                     <div class="listings-alls">
                        <div class="billing-details">
                            <h3 class="title font-strs font-sma">User Partial Space Listings    <a href="{{url('/add-partial-space-landlord')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                        </div>
                        <div class="row">
                    <div class="col-md-12">
                        <div class="main-search-wrap fll-s-st">
                              ...
                              <div class="col-lg-12 col-sm-12 col-md-6 single_listing_item{{$key->id}}">
                                    <div class="single-listing-item new-stl-lyt">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="listing-image">
                                                    <a href="{{url('/partialspacedetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>

                                                    <div class="listing-tag">
                                                        <a href="{{url('/partialspacedetails')}}/{{$key->id}}" class="d-block">{{$key->lease_type}} </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="listing-content pl-0">
                                                    <h3><a href="{{url('/partialspacedetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                                    <p class="mt-2 mb-2 fontsizepara">{{Getdesc($key->description,200,1)}}</p>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="price">
                                                            <b data-toggle="tooltip" data-placement="top">
                                                ...
                                                <div class="listing-box-footer br-st-a">
                                                    <a href="{{url('/partialspacedetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                    <a href="{{url('/edit-partial-space-landlord')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                                                   <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#delete-pop" class="delete_listing delete-ayr"> <i class="bx bx-trash"></i> </a>
                ...
                @elseif($title == 'User Pop Up Landloard Listings')
                    <div class="col-md-12">
                     <div class="listings-alls">
                        <div class="billing-details">
                            <h3 class="title font-strs font-sma">User Pop Up Landloard Listings <a href="{{url('/add-popup-landlord')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                        </div>
                        <div class="row">
                    <div class="col-md-12">
                        <div class="main-search-wrap fll-s-st">
                                    ...
                                    <div class="col flr-rng pl-0">
                                        <div class="form-group price-list-widget prics ">
                                            ...
                                            <div class="flex-saf">
                                                ...
                                                <div class="slc-fs">                                                   <select class="optin-msny" name="price_unit_popup">                  
                                                        <option>/day</option>
                                                        <option>/week</option>
                                                        <option>/month</option>
                                                    </select>
                            ...
                            @foreach($popuplandlord as $key)
                              <div class="col-lg-12 col-sm-12 col-md-6 single_listing_item{{$key->id}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="listing-image">
                                                <a href="{{url('/popupstoredetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>

                                                <div class="listing-tag">
                                                    <a href="{{url('/popupstoredetails')}}/{{$key->id}}" class="d-block">
                                        ...
                                        <div class="col-md-8">
                                            <div class="listing-content pl-0">
                                                <h3><a href="{{url('/popupstoredetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                                <p class="mt-2 mb-2 fontsizepara">{{Getdesc($key->description,200,1)}}</p>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="price">
                                                        <b data-toggle="tooltip" data-placement="top">
                                            ...
                                            <div class="listing-box-footer br-st-a">
                                                <a href="{{url('/popupstoredetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                <a href="{{url('/edit-popup-landlord')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                                                <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#delete-pop" class="delete_listing delete-ayr"> <i class="bx bx-trash"></i> </a>
                ...
                @elseif($title == 'User Events Fairs Markets')
                    <div class="col-md-12">
                    <div class="billing-details">
                        <h3 class="title font-strs font-sma">User Events Fairs Markets  <a href="{{url('/add-events-fairs-markets')}}" class="upgrd uprde"><i class="bx bx-plus"> </i> Add New </a> </h3>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                        <div class="main-search-wrap fll-s-st">
                              ...
                              <div class="col-lg-12 col-sm-12 col-md-6 single_listing_item{{$key->id}}">
                                    <div class="single-listing-item new-stl-lyt">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="listing-image">
                                                    <a href="{{url('/eventdetails')}}/{{$key->id}}" class="d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image"></a>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="listing-content pl-0">
                                                    <h3><a href="{{url('/eventdetails')}}/{{$key->id}}" class="d-inline-block">{{$key->name}}</a></h3>
                                                    <p class="mt-2 mb-2 fontsizepara">{{Getdesc($key->description,200,1)}}</p>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="price">
                                                            <b data-toggle="tooltip" data-placement="top">
                                                ...
                                                <div class="listing-box-footer br-st-a">
                                                    <a href="{{url('/eventdetails')}}/{{$key->id}}" class="view-ayr"> <i class="fa fa-eye"></i> </a>
                                                    <a href="{{url('/edit-events-fairs-markets')}}/{{$key->id}}" class="edit-ayr"> <i class="bx bx-pencil"></i> </a>
                                                    <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#delete-pop" class="delete_listing delete-ayr"> <i class="bx bx-trash"></i> </a>
                                                    <ul class="list-stra-al">
