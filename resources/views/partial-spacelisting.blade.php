                                        ...
                                        <div class="form-group price-list-widget prics ">
											...
											<div class="flex-saf">
												<div class="collection-filter-by-price">
                                                    <input class="range_input" type="text" data-min="0" data-max="500" data-step="10">
                                                    <input type="hidden" name="from_range" value="0" id="from_range">
                                                    <input type="hidden" name="to_rangefrom" value="500" id="to_range">
                                                </div>
												<div class="slc-fs">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 useraferlogin">
                        <div class="listings-alls">
                            ...
                            @if(count($partialspacelisting)>0)
                            @foreach($partialspacelisting as $key)

                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    <div class="single-listing-item partial-brdrs">
                                        <div class="listing-image">
											...
											<span class="lis-str-cat"> Partial Space </span>
                                        </div>
                        ...
                        <div class="listing-widget-area">
							...
							<!--div class="listing-widget filter-list-widget widtbgs">
                                ...
                                <div class="selected-filters-wrap-list">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class='bx bx-x'></i> Partial Space</a></li>
                           ...
                           <!--  <div class="listing-widget facilities-list-widget widtbgs">
                                ...
                                <ul class="facilities-list-row">
                                    ...
                                    <li  class="active"><a href="partial-space-listings.html">Partial Space</a></li>
