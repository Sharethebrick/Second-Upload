                    ...
                    <div class="col-lg-9 col-md-12 useraferlogin">
                        ...
                        <div class="listings-alls">
                            <div class="row searched_data">
                             @if(count($fullspacelisting)>0)
                                @foreach($fullspacelisting as $key)
                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    <div class="single-listing-item full-spce-brdr">
                                        <div class="listing-image">
                                            <a href="javascript:void(0);" data-id="{{$key->id}}" data-toggle="modal" data-target="#listing-popup" class="get_list_details_popup d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image">
                                            </a>
											...
											<span class="lis-str-cat"> Full Space </span>
                                        </div>
                        ...
                        <div class="listing-widget-area">
							...
							<!--div class="listing-widget filter-list-widget widtbgs">
                                ...
                                <div class="selected-filters-wrap-list">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class='bx bx-x'></i> Full Space</a></li>
                           ...
                           <!--  <div class="listing-widget facilities-list-widget widtbgs">
                                ...
                                <ul class="facilities-list-row">
                                    ...
                                    <li  class="active"><a href="full-space-listings.html">Full Space</a></li>
