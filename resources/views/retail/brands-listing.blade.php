                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-6">
                                        <div class="single-listing-item brands-brosr">
                                            <div class="listing-image">
                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#listing-popup" data-id="{{$key->id}}" class="get_list_details_popup d-block"><img src="{{url('/')}}/uploads/files/{{$key->image}}" alt="image">
                                                </a>
    											...
    											<span class="lis-str-cat"> Brands </span>
                                            </div>
