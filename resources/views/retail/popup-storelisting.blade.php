...
@section('content')
    ...
    <!-- Start Page Title Area -->
            s<div class="page-title-area page-title-bg3 pdd-sechr userbanner small-bsn">
            <div class="container">
        ...
        <section class="listing-area pb-5 ptb-100 bg-grey pdd-csts">
            <div class="container-fluid ">
                                    ...
                                    <div class="col flr-rng pl-0">
                                        <div class="form-group price-list-widget prics price_range_filter">
                                            ...
                                            <div class="flex-saf">
                                                ...
                                                <div class="slc-fs">
                                                    <select class="optin-msny form-control" name="price_unit_popup">
                                                        <option>/day</option>
                                                        <option>/week</option>
                                                        <option>/month</option>
                                                    </select>
               ...
               <div class="listings-alls">
                            ...
                            @if(count($popupstorelisting)>0)
                            @foreach($popupstorelisting as $key)
                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    <div class="single-listing-item popup-list">
                                        <div class="listing-image">
											...
											<span class="lis-str-cat"> Popup Store </span>
                                        </div>
                        ...
                        <div class="listing-widget-area">
							...
							<!--div class="listing-widget filter-list-widget widtbgs">
                                ...
                                <div class="selected-filters-wrap-list">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class='bx bx-x'></i> Pop Up Stores</a></li>
                           ...
                           <!--  <div class="listing-widget facilities-list-widget widtbgs">
                                ...
                                <ul class="facilities-list-row">
                                    ...
                                    <li  class="active"><a href="popup-store-listings.html">Pop Up Stores</a></li>
