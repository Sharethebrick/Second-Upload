                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="is_admin" value="@isset($is_admin){{$is_admin}}@endisset">
                                ...
                                <input type="hidden" name="brand_id" value="@if(@isset($brand_details)){{$brand_details->id}}@else{{0}}@endif">
                                    ...
                                    <h3 class="title font-strs">Business Services</h3>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>Title <span class="required">*</span></label>
                                                 <input type="text" class="form-control" name="title" value="@isset($brand_details){{$brand_details->title}}@endisset">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>Select Edition <span class="required">*</span></label>
                                                 <select class="form-control" name="selected_edition">
                                                    <option value="">Select One</option>
                                                    <option value="1" @isset($brand_details){{$brand_details->selected_edition == 1 ? 'selected' : ''}} @endisset>Retail Edition Listing  </option>
                                                    <option value="2" @isset($brand_details){{$brand_details->selected_edition == 2 ? 'selected' : ''}} @endisset>Office Edition Listing </option>
                                                    <option value="3" @isset($brand_details){{$brand_details->selected_edition == 3 ? 'selected' : ''}} @endisset>Residential Edition Listing </option>
                                                    <option value="4" @isset($brand_details){{$brand_details->selected_edition == 4 ? 'selected' : ''}} @endisset>All Edition Listing </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>Business Category <span class="required">*</span></label>
                                                 <select class="form-control multipleSelect1" name="business_category" autocomplete="off">
                                                    <option value="">Select One</option>
                                                    <option value="Accounting & Tax Services" @isset($brand_details){{$brand_details->business_category == 'Accounting & Tax Services' ? 'selected' : ''}} @endisset>Accounting & Tax Services</option>
                                                    <option value="Banking & Finance" @isset($brand_details){{$brand_details->business_category == 'Banking & Finance' ? 'selected' : ''}} @endisset>Banking & Finance</option>
                                                    <option value="Business Services" @isset($brand_details){{$brand_details->business_category == 'Business Services' ? 'selected' : ''}} @endisset>Business Services</option>
                                                    <option value="Home Improvement" @isset($brand_details){{$brand_details->business_category == 'Home Improvement' ? 'selected' : ''}} @endisset>Home Improvement</option>
                                                    <option value="Insurance" @isset($brand_details){{$brand_details->business_category == 'Insurance' ? 'selected' : ''}} @endisset>Insurance</option>
                                                    <option value="Internet & Web Services" @isset($brand_details){{$brand_details->business_category == 'Internet & Web Services' ? 'selected' : ''}} @endisset>Internet & Web Services</option>
                                                    <option value="Legal Services" @isset($brand_details){{$brand_details->business_category == 'Legal Services' ? 'selected' : ''}} @endisset>Legal Services</option>
                                                    <option value="Marketing & Advertising" @isset($brand_details){{$brand_details->business_category == 'Marketing & Advertising' ? 'selected' : ''}} @endisset>Marketing & Advertising</option>

                                                    <option value="Transportation/Moving" @isset($brand_details){{$brand_details->business_category == 'Transportation/Moving' ? 'selected' : ''}} @endisset>Transportation/Moving</option>

                                                    <option value="Interior Design" @isset($brand_details){{$brand_details->business_category == 'Interior Design' ? 'selected' : ''}} @endisset>Interior Design</option>                                                   
                                                    <option value="Office Equipment" @isset($brand_details){{$brand_details->business_category == 'Office Equipment' ? 'selected' : ''}} @endisset>Office Equipment</option>

                                                    <option value="Retail Equipment" @isset($brand_details){{$brand_details->business_category == 'Retail Equipment' ? 'selected' : ''}} @endisset>Retail Equipment</option>
                                                    
                                                    <option value="Other" @isset($brand_details){{$brand_details->business_category == 'Other' ? 'selected' : ''}} @endisset>Other</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>Website <span class="required">*</span></label>
                                                 <input type="url" class="form-control" name="website" value="@isset($brand_details){{$brand_details->website}}@endisset">
                                            </div>
                                        </div>
                ...
                $.ajax({
                        ...
                        success:function(result)
                        {
                           if($('#is_admin').val() == '1'){
                                 ...
                                 swal({title: "Success!", text: "Service Updated Successfully.", type: "success"},
                                          function(){
                                             window.location.href='<?php echo url("admin/service-listings"); ?>';
                                      }
                                   );
                            }else{
                              $('.submit_btn').html('Save').prop('disabled',false);
                                 ...
                                 <?php }else{ ?>
                                    swal({title: "Success!", text: "Service Added Successfully.", type: "success"},
                                      function(){
                                         window.location.href='<?php echo url("/retail/user-services"); ?>';
                                      }
                                   );
                                <?php } ?>
